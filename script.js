...
if (minute >= 0 && minute <= 15){
    ...
    console.log('не попадает в четверть');
}
// Пример 2
...
//}else {
//    console.log('в данном числе много значений');
//}
...
}else if( yellow == 'желтый'){
    console.log('Приготовся');
}else {
    {
        console.log('Зеленый! Можно переходить дорогу');
    }
}
